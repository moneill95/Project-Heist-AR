...
namespace Vuforia
{
	...
	/// </summary>
	public class ARSecurityPad : MonoBehaviour,
	ITrackableEventHandler
	{

		public GameObject SecurityPad;
		public bool SecurityPadOn;
		public int isSecurityPadOn;
		...
		void Update () {
			...
			if (SecurityPadOn == true) {
				isSecurityPadOn = 1;
				SecurityPad.SetActive (true);
			...
			PlayerPrefs.GetInt ("pSecurityPad", isSecurityPadOn);
		}

		public void DefenderReadyButton() 
		{
			PlayerPrefs.SetInt("pSecurityPad", isSecurityPadOn);	
